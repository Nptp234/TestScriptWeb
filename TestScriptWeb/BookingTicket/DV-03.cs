...
{
    class DatVeChonQuaNhieuGhe : ASetUp
    {
        [Test]
            ...
            if (driver.Url.Contains("https://localhost:44324/"))
            {
                ...
                if (!driver.Url.Contains(urlnow))
                {
                    ...
                    try
                    {
                        ...
                        wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[3]/button[1]")));
                    }
