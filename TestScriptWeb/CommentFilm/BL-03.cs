...
{
    class XoaBL0PhaiCuaTK : ASetUp
    {
        [Test]
        public void XoaBL0PhaiCuaKH()
        {
                    ...
                    foreach (var comment in oldComments)
                    {
                        ...
                        if (!name.Trim().ToLower().Equals(blUsername))
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    Assert.Fail("Có thể xóa bình luận người dùng khác!");
                                }
                                else
                                {
                                    Assert.Fail("Tìm thấy nút xóa!");
                                }

                            }
                            catch
                            {
                                Assert.Pass("Không tìm thấy nút xóa!");
                            }
                        }
                    }
                }
